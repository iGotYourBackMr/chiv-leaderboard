  ...
  return (
    <>
      ...
      <div className="w-full max-w-7xl mx-auto p-4 relative">
        {/* Toggle button for rank legend */}
        <button
          onClick={() => setIsRankLegendOpen(!isRankLegendOpen)}
          className="rank-legend-toggle"
          aria-label="Toggle rank legend"
        >
          <div className="flex flex-col items-center gap-2">
            {isRankLegendOpen ? (
              <>
                <X className="w-5 h-5 text-slate-300" />
                <span className="text-slate-300 text-xs font-medium rotate-180" style={{ writingMode: 'vertical-rl' }}>
                  CLOSE RANKS
                </span>
              </>
            ) : (
        ...
        {/* Rank Legend Panel */}
        <div className={`rank-legend ${isRankLegendOpen ? 'open' : ''}`}>
          <div className="rank-legend-content">
            <h3 className="rank-legend-title">Rank Tiers</h3>
            <div className="space-y-4">
              <div className="rank-legend-item">
                <div className="bg-[#423810] text-yellow-400 rank-legend-badge rounded-2xl">Grandmaster</div>
                <div className="text-base text-slate-400">2000+</div>
              </div>
              <div className="rank-legend-item">
                <div className="bg-[#2a1a37] text-purple-400 rank-legend-badge rounded-2xl">Master</div>
                <div className="text-base text-slate-400">1800-2000</div>
              </div>
              <div className="rank-legend-item">
                <div className="bg-[#1a2937] text-cyan-400 rank-legend-badge rounded-2xl">Diamond</div>
                <div className="text-base text-slate-400">1600-1800</div>
              </div>
              <div className="rank-legend-item">
                <div className="bg-[#1a2937] text-blue-400 rank-legend-badge rounded-2xl">Platinum</div>
                <div className="text-base text-slate-400">1400-1600</div>
              </div>
              <div className="rank-legend-item">
                <div className="bg-[#423810] text-yellow-600 rank-legend-badge rounded-2xl">Gold</div>
                <div className="text-base text-slate-400">1200-1400</div>
              </div>
              <div className="rank-legend-item">
                <div className="bg-[#1a1f2b] text-gray-400 rank-legend-badge rounded-2xl">Silver</div>
                <div className="text-base text-slate-400">1000-1200</div>
              </div>
              <div className="rank-legend-item">
                <div className="bg-[#2b1a1a] text-amber-700 rank-legend-badge rounded-2xl">Bronze</div>
                <div className="text-base text-slate-400">&lt;1000</div>
              </div>
            </div>
            <div className="mt-6 text-sm text-slate-500 text-center">
              Ranks are determined by<br />ELO rating in ranked duels.
            </div>
          </div>
        </div>
        ...
        {/* Overlay for mobile */}
        <div 
          className={`rank-legend-overlay ${isRankLegendOpen ? 'open' : ''}`}
          onClick={() => setIsRankLegendOpen(false)}
        />

        {/* Background glow effects */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-3xl">
          <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 to-blue-500/10 blur-[120px] rounded-full" />
        </div>

        {/* Main content container */}
        <div className="glass-container relative overflow-x-hidden sm:overflow-x-auto ml-[32px] mr-0 sm:ml-[32px] sm:mr-0 sm:w-auto w-[calc(100%-32px)]">
          {/* Header */}
